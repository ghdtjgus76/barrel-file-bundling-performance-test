 ...
 */
export interface TextField19Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField19 = forwardRef<HTMLTextAreaElement, TextField19Props>(
  (
    {
      helperText,
      label,
...
TextField19.displayName = "TextField19";
export default TextField19;
