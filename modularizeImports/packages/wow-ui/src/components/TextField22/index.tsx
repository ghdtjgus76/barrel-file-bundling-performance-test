 ...
 */
export interface TextField22Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField22 = forwardRef<HTMLTextAreaElement, TextField22Props>(
  (
    {
      helperText,
      label,
...
TextField22.displayName = "TextField22";
export default TextField22;
