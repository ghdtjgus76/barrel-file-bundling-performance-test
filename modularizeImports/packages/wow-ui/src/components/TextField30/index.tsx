 ...
 */
export interface TextField30Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField30 = forwardRef<HTMLTextAreaElement, TextField30Props>(
  (
    {
      helperText,
      label,
...
TextField30.displayName = "TextField30";
export default TextField30;
