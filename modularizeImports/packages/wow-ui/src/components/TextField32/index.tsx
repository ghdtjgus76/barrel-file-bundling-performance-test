 ...
 */
export interface TextField32Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField32 = forwardRef<HTMLTextAreaElement, TextField32Props>(
  (
    {
      helperText,
      label,
...
TextField32.displayName = "TextField32";
export default TextField32;
