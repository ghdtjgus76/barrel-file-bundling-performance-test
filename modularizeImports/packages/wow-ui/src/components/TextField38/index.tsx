 ...
 */
export interface TextField38Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField38 = forwardRef<HTMLTextAreaElement, TextField38Props>(
  (
    {
      helperText,
      label,
...
TextField38.displayName = "TextField38";
export default TextField38;
