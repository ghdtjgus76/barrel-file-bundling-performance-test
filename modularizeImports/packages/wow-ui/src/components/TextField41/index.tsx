 ...
 */
export interface TextField41Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField41 = forwardRef<HTMLTextAreaElement, TextField41Props>(
  (
    {
      helperText,
      label,
...
TextField41.displayName = "TextField41";
export default TextField41;
