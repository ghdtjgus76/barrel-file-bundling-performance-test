 ...
 */
export interface TextField42Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField42 = forwardRef<HTMLTextAreaElement, TextField42Props>(
  (
    {
      helperText,
      label,
...
TextField42.displayName = "TextField42";
export default TextField42;
