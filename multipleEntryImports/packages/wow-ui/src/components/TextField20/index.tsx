 ...
 */
export interface TextField20Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField20 = forwardRef<HTMLTextAreaElement, TextField20Props>(
  (
    {
      helperText,
      label,
...
TextField20.displayName = "TextField20";
export default TextField20;
