 ...
 */
export interface TextField36Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField36 = forwardRef<HTMLTextAreaElement, TextField36Props>(
  (
    {
      helperText,
      label,
...
TextField36.displayName = "TextField36";
export default TextField36;
