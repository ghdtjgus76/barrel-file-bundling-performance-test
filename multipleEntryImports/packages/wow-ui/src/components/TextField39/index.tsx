 ...
 */
export interface TextField39Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField39 = forwardRef<HTMLTextAreaElement, TextField39Props>(
  (
    {
      helperText,
      label,
...
TextField39.displayName = "TextField39";
export default TextField39;
