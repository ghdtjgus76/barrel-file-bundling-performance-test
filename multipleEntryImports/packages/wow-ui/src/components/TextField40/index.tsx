 ...
 */
export interface TextField40Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField40 = forwardRef<HTMLTextAreaElement, TextField40Props>(
  (
    {
      helperText,
      label,
...
TextField40.displayName = "TextField40";
export default TextField40;
