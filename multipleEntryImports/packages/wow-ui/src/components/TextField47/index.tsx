 ...
 */
export interface TextField47Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField47 = forwardRef<HTMLTextAreaElement, TextField47Props>(
  (
    {
      helperText,
      label,
...
TextField47.displayName = "TextField47";
export default TextField47;
