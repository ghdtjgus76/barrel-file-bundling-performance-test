 ...
 */
export interface TextField48Props {
  label: string;
  placeholder?: string;
  defaultValue?: string;
  value?: string;
...
const TextField48 = forwardRef<HTMLTextAreaElement, TextField48Props>(
  (
    {
      helperText,
      label,
...
TextField48.displayName = "TextField48";
export default TextField48;
